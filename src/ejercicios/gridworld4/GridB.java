...
public class GridB {
    ...
    public static void main(String[] args) {
        ...
        SarsaLamda algoritmoo = new SarsaLamda(cantidadEstados, ACCIONES, Entorno.entorno4Modificado(), Reward.reward4Modificado(), EPISODIOS, new int[1]);
